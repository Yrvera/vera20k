...
rejected findings with evidence, recheck prior fixes and obtain independent re-review
until passed. Keep delegation prompts short. Adjacent discoveries do not automatically
expand implementation scope; follow ENGINE.md's prerequisite guidance.
...
does not grant merge authority. Validate and independently review before merging.
...
whole-scope reverse audit for omissions, cross-mechanism gaps and regressions, plus
applicable production and ENGINE.md validation. Ranked or refactoring goals may finish
with explicitly allowed deferrals or independently reviewed evidence-backed no-change
