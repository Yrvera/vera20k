...
if __name__ == '__main__':
    finish_vectors(generate, Path(__file__).with_suffix('.json'), provenance=lambda: provenance(scope='original BuildingType virtual+84 callback45EDD0, Techno711F00 and actualcost+AC45ED50. Declared type costs/free unit and House cost multipliers; stock SeparateAircraft=true. No producer for live multipliers/country fields, full House recalc, or Rust parity claim.', assumptions=['Original BuildingTypeVT7E4570 and UnitTypeVT7F6218; native Cost+610 and FreeUnit+EA0 populated directly. Supplied HouseType cost fields114..124 and House5390..53A0 floats. Unused object storagezero; BuildingBuildCat0.', 'PadAircraft first pointer and Dock first pointer valid but do not equal Building; supplied SeparateAircrafttrue excludes legacy bundled-aircraft adjustment. No null/malformed configuration claim.'], substitutions=[], entry_points={'building_cost84': 4582864, 'techno_cost84': 7413504, 'country_factor': 5291504, 'house_factor': 5291696, 'building_actual_cost': 4582736, 'raw_cost': 7413424}))
