...
| `tools.spatial_oracle.shroud_current_sight` | 15 ordinary-cell reveal/gap/fire/Psychic/120-frame sequences; actual MapCell, selected Gap blocks and complete periodic sweep | `src/sim/vision/vision_tests.rs`; world, restore and tactical CPU regressions |
