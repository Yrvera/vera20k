...
const FROZEN_EXCEPTIONS: &[(&str, &str)] = &[
    ...
    // F04: sequence vocabulary/catalog construction moves to rules.
    ("rules/infantry_sequence.rs", "sim"),
    ("rules/shp_vehicle_sequence.rs", "sim"),
    // F04: installed locomotor parsing consolidates in rules::locomotor_type.
    ("rules/object_type.rs", "sim"),
    // F04: sequence catalog + interned handles leave RuleSet.
