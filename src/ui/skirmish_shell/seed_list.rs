//! Saved-browser list and scrollbar geometry from 0x00618D40 / 0x0061C690.
//! Native list rows use GAME.FNT height 17 + 2; inner rectangles exclude borders.

use super::layout::{RectPx, SavedSeedControl};

pub const ROW_HEIGHT: i32 = 19;

#[derive(Debug, Clone, Copy)]
pub struct SeedListGeometry {
    pub outer: RectPx,
    pub content: RectPx,
...
mod tests {
    ...
    fn border_and_scroll_range_share_one_geometry_for_hit_and_paint() {
        let list = SeedListGeometry::new(RectPx::new(10, 20, 400, 255), 23, 10);
