...
mod tests {
    ...
    /// and immutable entity membership.
    #[test]
    fn phase3_combined_snapshot_version_is_106() {
    ...
    fn naval_build_const_order_and_membership_roundtrip_with_current_hash_only() {
        ...
        assert_eq!(
            ...
            historical_pre_v28,
            "the historical pre-v28 probe excludes v106 state"
        );
        assert_eq!(
            sim.state_hash_without_mission_v29(),
            historical_pre_v29,
            "the historical pre-v29 probe excludes v106 state"
        );
        sim.houses
            .get_mut(&owner)
            .unwrap()
