...
/// Re-baselined for SC-2 (session identity — seed, map name, theater,
/// bounds, MP start table — folded into the hash; composition change, not a
/// behavior drift).
const SLICE6_BASELINE_HASH: u64 = 6388957604790883389;
