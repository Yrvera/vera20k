...
fn phase3_flat_display_order_roundtrips_and_changes_the_state_hash() {
    ...
    assert_eq!(
        sim.state_hash_without_flat_display_order_v121(),
        opposite.state_hash_without_flat_display_order_v121(),
...
fn phase3_anim_constructor_layer_is_current_hash_authority_only() {
    ...
    assert_eq!(
        layer3.state_hash_without_flat_display_order_v121(),
        layer4.state_hash_without_flat_display_order_v121(),
