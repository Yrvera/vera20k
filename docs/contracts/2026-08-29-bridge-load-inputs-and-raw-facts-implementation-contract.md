...
| Installed retail MIX chain under `C:\Users\enok\Documents\Command and Conquer Red Alert II` | Primary retail | Exact automatic-shell corpus result: 64 unique fixed-band base IDs, eight absent base files, 56 present bases plus ten variants = 66 loaded TMP assets, 731 present subcells, and 36 qualifying subcells |
