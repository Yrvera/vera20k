...
| Mission `0x10` checks `RadioClass::In_Radio_Contact` (formerly mislabeled PathType__Has_Valid_Steps) before the facing/unload-start gate. | `UNIT_MISSION_DEPLOY_BUILDING_UNLOAD_START_IMPLEMENTATION_VERIFICATION_GHIDRA_REPORT.md` section 3.3. | Yes | High |
