...
| `0x00497100` | `Blitter_ZClip_Plain16_WritesZ` | Z R+W BUILDNGZ; extended-selector `0x4000`-set/`0x800`-clear arm (`0x00490f45`), not the normal body route (the live body leaves are `0x004990e0`/`0x004958d0`, corrected 2026-09-07, see ZBUFFER_DEPTH_SYSTEM.md Overview) | ZBUFFER_DEPTH |
