...
- `C:/Users/enok/Documents/ra2-rust-game-docs/skirmish-ui/SKIRMISH_COMBO_DROPDOWN_WINDOW_GEOMETRY_GHIDRA_REPORT.md`: superseded by the follow-up correction now in that file: `ComboDropWin` is registered with WndProc block `0x0060D540` and owns the standard combo popup row loop; `OwnerDraw_ListBox_00618D40` remains the real owner-drawn `LISTBOX` callback.
