...
- Rust scanned read-only: `src/ui/skirmish_shell/layout.rs`, `src/ui/skirmish_shell/state.rs`, `src/ui/skirmish_shell/mod.rs`, `src/app_skirmish_shell_render.rs`, plus targeted `rg` checks for `0x695`, `0x699`, `0x69B`, `0x69C`, `status`, and `help`.
