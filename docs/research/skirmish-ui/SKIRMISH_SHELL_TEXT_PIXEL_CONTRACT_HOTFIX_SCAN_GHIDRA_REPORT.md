...
- `docs/research/skirmish-ui/SKIRMISH_OWNERDRAW_BUTTON_PIXEL_LAYOUT_GHIDRA_REPORT.md` replacement wording: "The `FUN_00621040` text alignment flags for default Skirmish buttons are `0x05` (`h-center | v-center`). The nearby `PUSH 0x0C` is an adjacent wrapper argument and must not be interpreted as the alignment flags."
- `docs/research/skirmish-ui/SKIRMISH_TEXT_RENDERER_CALLER_PIXEL_CONTRACT_GHIDRA_REPORT.md` replacement wording for color notes: "Packed shell text colors are caller RGB in `0x00BBGGRR` byte order before DirectDraw loss/shift packing; therefore `0x00000C05` is RGB `(5,12,0)` and `DAT_00AC18A4 = 0x0000FFFF` is RGB `(255,255,0)`."
...
- Prior docs referenced: `docs/research/BITFONT_SHELL_TEXT_GHIDRA_REPORT.md`, `docs/research/skirmish-ui/SKIRMISH_TEXT_RENDERER_CALLER_PIXEL_CONTRACT_GHIDRA_REPORT.md`, `docs/research/skirmish-ui/SKIRMISH_OWNERDRAW_BUTTON_PIXEL_LAYOUT_GHIDRA_REPORT.md`, `docs/research/skirmish-ui/SKIRMISH_TEXT_PREVIEW_STATIC_CONTROLS_GHIDRA_REPORT.md`, `docs/research/skirmish-ui/SKIRMISH_DROPDOWN_ROW_INTERNAL_PAINT_GHIDRA_REPORT.md`, `docs/research/skirmish-ui/SKIRMISH_CHECKBOX_TRACKBAR_PIXEL_GEOMETRY_GHIDRA_REPORT.md`, `docs/research/skirmish-ui/SKIRMISH_OWNERDRAW_COMBOBOX_00617250_GHIDRA_REPORT.md`.
- Rust read-only scan: `src/render/shell_text.rs`, `src/app_skirmish_shell_render.rs`, `src/ui/skirmish_shell/layout.rs`, `src/ui/skirmish_shell/state.rs`.
