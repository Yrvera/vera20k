...
`417dfe4df354ccf3d5e7adfd4fe1a52b1d8694fd`, refreshed after verified PR #330 merge on 2026-09-10.
...
| 50 | GSI-04.18 | `src/sim/vision/mod.rs`; `src/sim/snapshot.rs` | [shroud reveal](../../research/SHROUD_REVEAL_SYSTEM_GHIDRA_REPORT.md) | ANCHORED / PARTIAL / UNCHECKED | Ordinary sight, transient mapping, pending conceal and retained source/viewer authority merged in PR #330. Independent review and original-byte ordering comparison confirm that House power reconciliation publishes gap removal before the native Building visit; [correction evidence](../../research/PHASE3_GAP_OPERATIONAL_PUBLICATION_NATIVE_REPORT.md) is retained, production delivery pending. Historical SHROUD_DISPARITIES is not a current gap list. |
