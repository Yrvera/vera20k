...
|---|---|---|---|---|---|---|---|---|
| T1-01 | Hover | high intact | onto | move | **KNOWN-BROKEN** | BayOPigs.mmx, approach `(111,152)` → deck `(111,151)`, LOOSE | OI-06 (=L1+L2) | Re-run `hover_tank_is_currently_blocked_from_entering_a_high_bridge` on current HEAD with the gate ON. Its verdict was recorded at `ef643809`, **one commit before** the deck exemption `cf91caa3`, and nobody re-ran it. Cheapest measurement in the whole program. |
