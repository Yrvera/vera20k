...
- Null branch order is `RadioClass::In_Radio_Contact` (formerly mislabeled PathType__Has_Valid_Steps), optional radio `3`, `Queue_Mission(0x0A, 1)`, then mission timer epilogue. Source: `docs/research/miner/MISSING_DESTROYED_REFINERY_MID_UNLOAD_ORDERING_GHIDRA_REPORT.md:74-87`.
